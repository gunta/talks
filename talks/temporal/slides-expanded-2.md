...
<!--
この機能は、AIエージェントの作り方を根本から変えます。
これまでは、AIにあらゆることを推測させて、完璧に動く執事を目指していました。
でもこれからは、分からないことは素直に聞いてくる、優秀なアシスタントを育てる、という考え方に変わります。
いかに賢く、的確な質問をAIにさせるか。それが僕たち開発者の新しい仕事になります。
-->
<!-- Midjourney Prompt: A visual metaphor comparing two AI robots. One is a stiff, formal butler trying to guess what its master wants. The other is a friendly, approachable assistant with a notepad, asking a question to its user. --ar 16:9 --v 7 -->
