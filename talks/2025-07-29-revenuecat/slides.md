...
<!--
みなさん、こんにちは！今日は本当は教えたくない、でも日本のみなさんのために特別に公開する「G Stack」について話します。
これを使えば、RevenueCat Shipatonで賞金1000万円も夢じゃありません！
-->
...
<!--
CyberAgentでDeveloper Productivityを担当しているGüntherです。
今日は25分という短い時間ですが、濃密な情報をお届けします。
初心者の方も、経験者の方も、全員が今日から使える実践的な内容です。
-->
...
<!--
今日のゴールは明確です。
RevenueCat Shipatonで勝つための技術スタックを理解し、
最速で開発するためのツール選定基準を学び、
有料級の情報を持ち帰っていただくことです。
-->
...
<!--
なぜG Stackなのか？答えはシンプルです。
ハッカソンは時間との戦いです。スピードがすべてです。
-->
...
<!--
まず大切なのはメンタリティです。
スピード、美しさ、パフォーマンス、すべてが重要です。
そしてコンテキストがすべての鍵となります。
-->
...
<!--
Phase 1はリサーチです。
良いアイデアは良いリサーチから生まれます。
OpenAI o3、Grok 4、Claude Code Opus 4を使い分けて、
市場のペインポイントを見つけましょう。
-->
...
<!--
Phase 2はいよいよコーディングです。
WebならBolt.new、ネイティブならa0.devを使います。
特にa0.devはConvexとExpoが統合されていて、AI生成コードに最適です。
-->
...
<!--
Phase 3はコンテキストエンジニアリングです。
プロジェクトの情報をすべてコード化し、
AIが理解しやすい形で管理します。
そして、ここからがG Stackの本領発揮です。
-->
...
<!--
G Stackの基盤部分です。
特に重要なのはConvexです。これがAI時代の最強データベースです。
完全な型安全性とリアルタイム機能が、開発速度を劇的に向上させます。
-->
...
<!--
Web開発のG Stackです。
AstroとTanStack Starterの使い分けが重要です。
静的ならAstro、動的ならTanStack Starterを選びましょう。
-->
...
<!--
Native開発のG Stackです。
Expoを使えば、Webエンジニアでもネイティブアプリが作れます。
しかもRevenueCat SDKにも完全対応しています。
-->
...
<div class="mt-4 bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-6 rounded-xl">
...
<!--
実際のビルドフェーズです。
AIツールを使い分けて、効率的に開発します。
特にClaude Codeのサブエージェントは強力です。
-->
...
<!--
ありがとうございました！
G Stackを使って、RevenueCat Shipatonで賞金1000万円を掴みましょう！
質問がある方は、ぜひ懇親会でお声がけください。
Let's ship and win together!
-->